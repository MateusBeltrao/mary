import { Circle, Facebook, Heart, Instagram, Linkedin, 
    Mail, MapPin, Phone, Twitter } from 'lucide-react'
...
const Footer = () => {
  ...
  return (
    ...
    left-10 w-16 h-16 rounded-full opacity-20'></div>
    <div className='absolute border-2 border-yellow-500 top-20
    right-10 w-20 h-20 rounded-full opacity-20'></div>
    </footer>
  )
}
